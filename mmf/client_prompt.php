...
<div class='gradient container' >
	<div class='box'>
		<h1 class='pergunta__box font-family color-font'>Olá $firstname, você já tem cadastro na Magneto Elenco?</h1>
	</div>
	<div class='box'>
		<div class='box-outline_box'>
			<div class='column-full font-family color-font'>

				<input class='radio-inline__input-full' id='sim' name='client_prompt' type='submit' value='sim' onclick='showLoading()'>
				<label class='radio-inline__label-full cursor' for='sim'> 
					Sim
				</label>
				<input class='radio-inline__input-full' id='nao' name='client_prompt' type='submit' value='nao' onclick='showLoading()'>
	...
	if (!empty($_POST['client_prompt'])) {
		$_SESSION['client_prompt'] = $_POST['client_prompt'];
