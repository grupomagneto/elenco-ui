...
try {
    ...
    if (!empty($_SESSION['facebook_access_token'])) {
		...
		$sql_photo = "SELECT arquivo FROM tb_foto WHERE cd_elenco='$voter_elenco_ID' ORDER BY dh_cadastro ASC LIMIT 0, 1";
			      ...
			      <div class='box box-outline__content-after-login'>
			        ...
			        <div class='row'>
			          <p class='content-slide_after-login before_questions font-family color-font'>
			            Pronto $firstname!<BR />Seu cadastro foi localizado e atualizado com sucesso!
			          </p>
			        </div>
