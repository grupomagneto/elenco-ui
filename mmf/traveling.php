...
$id         = $_SESSION['id'];
$pergunta 	= 'Com que frequência você costuma viajar?';
$id1 		    = 'uma';
$id2        = 'duas';
$id3        = 'todomes';
$id4        = 'nunca';
$opcao1 	  = 'Uma vez por ano';
$opcao2     = 'Duas ou mais vezes por ano';
$opcao3     = 'Praticamente todo mês';
$opcao4     = 'Não costumo viajar';
$name       = 'traveling';
$extra 		  = ' ';
