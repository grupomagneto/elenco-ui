...
<div class="progress1">
<progress id="progressbar1" value="10" max="80" ></progress>
</div>
        <nav>
...
<div class="progress1">
 <progress id="progressbar" value="65" max="80"></progress>
</div>
        <nav>
        <ul class="vs-vertical-nav none">
          <li><a href="#" class="vs-prev swiper-control prev"></a></li>
...
<div class="modal modal_gratuito_mobile" id="gratuito_mobile" role="dialog" aria-labelledby="myLargeModalLabel">
 <div class="modal-content conteudo_gratuito_mobile">
  <h3>termos e condições</h3>
    <ol>Você, <span class="concat_texto"></span>, está contratando a MAGNETO ELENCO para divulgar sua imagem e intermediar sua contratação junto a PRODUTORAS AUDIOVISUAIS, CLIENTES ANUNCIANTES e AGÊNCIAS DE PUBLICIDADE E PROMOÇÃO DE EVENTOS;</li>
    <li>Para isso nos autoriza a utilizar sua imagem em nossos canais de comunicação;</li>
    <li>Nós não garantimos conseguir trabalhos para você, assim como você não tem obrigação de aceitar os trabalhos que lhe oferecermos;</li>
    <li>Porém, uma vez que você aceite um trabalho que lhe oferecermos, você deverá realizá-lo ou poderá ter que pagar uma multa;</li>
    <li>Você optou pelo CADASTRO GRATUITO e por isso sua remuneração será de apenas 20% do CACHÊ LÍQUIDO no seu PRIMEIRO TRABALHO e de 60% do CACHÊ LÍQUIDO no seu segundo trabalho em diante (Cachê Líquido é o Cachê Bruto recebido pela Magneto Elenco descontados 20% de impostos);</li>
     <li>Você não precisa pagar para se agenciar;</li>
     <li>Você não poderá estar inscrito em outra agência enquanto nosso contrato estiver valendo;</li>
     <li>Nosso contrato valerá por 24 meses;</li>
   </ol>
