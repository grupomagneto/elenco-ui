<form id="form-boleto" action="#" method="post">
    <div class='conteudo flexbox wrap text-align-center space-between-vertical justify-center'>
        <div class='conteudo flexbox wrap text-align-center space-between-vertical justify-center'> 
            ...
            <div class='botoes'>
                ...
                <input type="hidden" name="nome_pagador" id="input-hidden-boleto-nome_titular" value="" />
                ...
                <input type="hidden" name="produto" id="input-hidden-boleto-produto" value="" />
                <input type="hidden" name="valor" id="input-hidden-boleto-valor" value="" />
                <input type="hidden" name="forma_pagamento" id="input-hidden-boleto-forma_pagamento" value="" />
                <input type="hidden" name="desconto" id="input-hidden-boleto-desconto" value="0" />
