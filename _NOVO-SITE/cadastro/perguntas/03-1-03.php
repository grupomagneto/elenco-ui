<div class='conteudo flexbox wrap text-align-center validacao-ok'>
    <div class='conteudo flexbox wrap text-align-center validacao-ok'>
        ...
        <input type="text" name="ddd" class="input_ddd inputs" placeholder="00" maxlength="2" /><input type="text" name="celular" class="input_celular inputs" placeholder="0 0000 0000" />
