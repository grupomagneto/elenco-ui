    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
    	...
    	<div class="col-md-12">
            ...
            <div class="form-group">
            	...
            	<input type="email" name="email" class="form-control" placeholder="Seu email" maxlength="40" autocomplete="off" />
                </div>
            ...
            <div class="form-group">
            	...
            	<input type="password" name="pass" class="form-control" placeholder="Sua senha" maxlength="15" autocomplete="off" />
                </div>
