...
$codigo_moip = $_POST['codigo_moip'];
if ($forma_pagamento == "Boleto Bancário") {
	$status_venda = "Boleto Impresso";
	// ATUALIZA STATUS VENDA
	mysqli_query($link, "UPDATE financeiro SET forma_pagamento = '$forma_pagamento', n_parcelas = '$n_parcelas', status_venda = '$status_venda', data_venda = '$hoje', codigo_moip = '$codigo_moip' WHERE id = '$id_venda'");
}
elseif ($forma_pagamento == "Cartão de Crédito") {
	$status_venda = "Em análise";
	$valor_venda = $_POST['valor_venda'];
	// ATUALIZA STATUS VENDA
	mysqli_query($link, "UPDATE financeiro SET valor_venda = '$valor_venda', forma_pagamento = '$forma_pagamento', n_parcelas = '$n_parcelas', status_venda = '$status_venda', data_venda = '$hoje', codigo_moip = '$codigo_moip' WHERE id = '$id_venda'");
