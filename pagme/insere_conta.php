      ...
      ?>
        ...
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            <input type="text" name="nome" class="form-control" value="<?php echo $userRow['nome']; ?>" disabled />
            </div>
        ...
        <div class="form-group">
          ...
          <div class="input-group">
            <span class="input-group-addon"><span class="glyphicon glyphicon-piggy-bank"></span></span>
            <input type="number" name="bank_agency" class="form-control" placeholder="Digite o código da sua agência" required />
            </div>
        <!-- <span class="text-danger"><?php echo $emailError; ?></span> -->
        </div>
        ...
        <div class="form-group">
          ...
          <div class="input-group">
            <span class="input-group-addon"><span class="glyphicon glyphicon-piggy-bank"></span></span>
            <input type="number" name="bank_account" class="form-control" placeholder="Digite o número da sua conta bancária" required />
            </div>
        <!-- <span class="text-danger"><?php echo $emailError; ?></span> -->
        </div>
