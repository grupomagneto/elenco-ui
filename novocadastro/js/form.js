...
/*          function gravar(){
            var nome = document.getElementById("nome_menor").value;
...
return false
 ...
 if (document.form.sexo[0].checked == false 
    && document.form.sexo[1].checked == false) {
    $( "#erro" ).toggle();
    return false
}
...
return false
 ...
 if (document.form2.sexo[0].checked == false 
    && document.form2.sexo[1].checked == false) {
    $( "#erro" ).toggle();
    return false
}
